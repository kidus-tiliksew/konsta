...
exports.RangeClasses = void 0;
var _cls = require("../cls.js");
const RangeClasses = (props, colors, darkClasses) => {
  return {
    base: {
    ...
    trackBg: {
      common: (0, _cls.cls)('absolute top-1/2 left-0 w-full transform -translate-y-1/2 bg-black bg-opacity-20', darkClasses('dark:bg-white dark:bg-opacity-20')),
...
exports.RangeClasses = RangeClasses;